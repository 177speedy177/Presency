  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 50% 40%, rgba(201,168,76,0.10) 0%, transparent 65%)" }}
      />

      <div className="relative z-10 max-w-2xl mx-auto px-6 lg:px-8 text-center">
        <RevealDiv>
          <p className="eyebrow mb-6">FREE · NO COMMITMENT</p>
        </RevealDiv>

        <RevealDiv delay={80}>
          <h2
            className="font-display mb-5"
            style={{ fontSize: "clamp(2rem,5vw,3.5rem)", fontWeight: 300, color: "var(--text-primary)", lineHeight: 1.1 }}
          >
        ...
        <RevealDiv delay={160}>
          <p className="font-body text-base mb-8" style={{ color: "var(--text-secondary)" }}>
            The Patient Capture Audit maps every place a new-patient opportunity could be slipping through. Missed calls, after-hours gaps, web inquiry response time, review presence. You get a clear picture in a 15-minute call.
          </p>
        </RevealDiv>
        ...
        <RevealDiv delay={300}>
          <div className="flex flex-wrap justify-center gap-6">
            {["No commitment required", "Results in 48 hours", "No patient data collected"].map((t) => (
